...
namespace Algorithms.Lesson_5
{
    ...
    public enum TreeTraversal { PreOrder, LevelOrder };
    ...
    public class BinaryTree : ITree<int>
    {
        ...
        /// </summary>
        /// <returns></returns>
        public Node<int>[] GetTree(TreeTraversal traversal)
        {
            switch(traversal)
            {
                case TreeTraversal.PreOrder: { return GetTreePreOrderTraversal(); }
                case TreeTraversal.LevelOrder: { return GetTreeLevelOrderTraversal(); }
                default: return null;
            }
        }
        /// <summary>
        ...
        /// </summary>
        public void PrintTree() => DataVisualization.PrintBinaryTree(GetFullTree(), Depth);
        ...
        private Node<int>[] GetTreeLevelOrderTraversal()
        {
        ...
        private Node<int>[] GetTreePreOrderTraversal()
        {
            if (Root == null) return null;
        ...
        private Node<int>[] GetFullTree()
        {
            ...
            do
            {
                ...
                if (currentNode != null)
                {
                    stack.Enqueue(currentNode.Left);
                    stack.Enqueue(currentNode.Right);
            ...
            } while (stack.Count > 0 && listNode.Count < maxNodeCount);
            return listNode.ToArray();
        }
        private bool RemoveItemRecursiv(int value)
        {
